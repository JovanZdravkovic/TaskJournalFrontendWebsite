...
const routes: Routes = [
  ...
  { path: 'tasks_history', component: TasksHistoryComponent, canActivate: [AuthGuard], data: { authRequired: true } },
  { path: 'task_history/:id', component: TaskHistoryComponent, canActivate: [AuthGuard], data: { authRequired: true } },
